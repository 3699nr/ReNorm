...
class DukeMTMC_1(ImageDataset):
    ...
    def __init__(self, root='datasets', **kwargs):
        # self.root = osp.abspath(osp.expanduser(root))
        self.root = root
        self.dataset_dir = "/home/nr_2022/data/duke/"
        self.train_dir = osp.join(self.dataset_dir, 'bounding_box_train')
        self.query_dir = osp.join(self.dataset_dir, 'query')
        self.gallery_dir = osp.join(self.dataset_dir, 'bounding_box_test')
        ...
        super(DukeMTMC_1, self).__init__(train, query, gallery, **kwargs)
...
class DukeMTMC_2(ImageDataset):
    ...
    def __init__(self, root='datasets', **kwargs):
        ...
        super(DukeMTMC_2, self).__init__(train, query, gallery, **kwargs)
...
class DukeMTMC_3(ImageDataset):
    ...
    def __init__(self, root='datasets', **kwargs):
        ...
        super(DukeMTMC_3, self).__init__(train, query, gallery, **kwargs)
