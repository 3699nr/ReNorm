...
class Market1501All(ImageDataset):
    """Market1501.
    ...
    dataset_name = "Market1501All"  

    def __init__(self, root='datasets', market1501_500k=False, **kwargs):
        # self.root = osp.abspath(osp.expanduser(root))
        self.root = root
        self.dataset_dir = osp.join(self.root, 'Market-1501-v15.09.15')
        ...
        ### all datasets  1.13 add
        train = train + query + gallery
        super(Market1501All, self).__init__(train, [], [], **kwargs)  
