...
def default_argument_parser():
    ...
    parser.add_argument("--config-file", default="./configs/Market1501/bagtricks_R50.yml", metavar="FILE", help="path to config file")
    parser.add_argument(
        "--resume", type = bool, 
        default= False,
    ...
    parser.add_argument("--test_datasets", nargs='+', type=str) 
...
class DefaultTrainer(TrainerBase):
    ...
    def __init__(self, cfg):
        ...
        data_loader_list, train_num_classes = self.build_train_loader(cfg)


        cfg = self.auto_scale_hyperparams(cfg, train_num_classes)
        ...
        self._trainer = (AMPTrainer if cfg.SOLVER.FP16_ENABLED else SimpleTrainer)(
            cfg, model, data_loader_list, optimizer
        )
    ...
    def test(cls, cfg, model):
        ...
        for idx, dataset_name in enumerate(cfg.DATASETS.TESTS):
            ...
            try:
                ...
                continue
            results_i = inference_on_dataset(cfg, model, data_loader, evaluator, flip_test=cfg.TEST.FLIP_ENABLED)
