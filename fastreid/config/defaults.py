...
_C.MODEL.LOSSES.TRI_RN = CN()
_C.MODEL.LOSSES.TRI_RN.MARGIN = 0.5
_C.MODEL.LOSSES.TRI_RN.NORM_FEAT = False
_C.MODEL.LOSSES.TRI_RN.HARD_MINING = True
_C.MODEL.LOSSES.TRI_RN.SCALE = 1.0

_C.MODEL.LOSSES.TRI_EN = CN()
_C.MODEL.LOSSES.TRI_EN.MARGIN = 1.0
_C.MODEL.LOSSES.TRI_EN.NORM_FEAT = False
_C.MODEL.LOSSES.TRI_EN.HARD_MINING = True
_C.MODEL.LOSSES.TRI_EN.SCALE = 1.0
...
_C.DATASETS.BIG_to_SMALL = False
